# Script import dashboard cho demo-v66
param(
...
Write-Host "=== Import Dashboard for demo-v66 ===" -ForegroundColor Cyan
...
Write-Host "Dashboard import completed for demo-v66!" -ForegroundColor Green