# Script import dashboard cho demo-v27
param(
...
Write-Host "=== Import Dashboard for demo-v27 ===" -ForegroundColor Cyan
...
Write-Host "Dashboard import completed for demo-v27!" -ForegroundColor Green
