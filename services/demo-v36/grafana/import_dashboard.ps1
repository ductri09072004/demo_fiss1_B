# Script import dashboard cho demo-v36
param(
...
Write-Host "=== Import Dashboard for demo-v36 ===" -ForegroundColor Cyan
...
Write-Host "Dashboard import completed for demo-v36!" -ForegroundColor Green