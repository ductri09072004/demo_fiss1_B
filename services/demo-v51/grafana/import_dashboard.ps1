# Script import dashboard cho demo-v51
param(
...
Write-Host "=== Import Dashboard for demo-v51 ===" -ForegroundColor Cyan
...
Write-Host "Dashboard import completed for demo-v51!" -ForegroundColor Green