# Script import dashboard cho demo-v30
param(
...
Write-Host "=== Import Dashboard for demo-v30 ===" -ForegroundColor Cyan
...
Write-Host "Dashboard import completed for demo-v30!" -ForegroundColor Green
