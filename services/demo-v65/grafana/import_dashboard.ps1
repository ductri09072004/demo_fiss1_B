# Script import dashboard cho demo-v65
param(
...
Write-Host "=== Import Dashboard for demo-v65 ===" -ForegroundColor Cyan
...
Write-Host "Dashboard import completed for demo-v65!" -ForegroundColor Green