# Script import dashboard cho demo-v50
param(
...
Write-Host "=== Import Dashboard for demo-v50 ===" -ForegroundColor Cyan
...
Write-Host "Dashboard import completed for demo-v50!" -ForegroundColor Green