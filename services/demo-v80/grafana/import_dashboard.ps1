# Script import dashboard cho demo-v80
param(
...
Write-Host "=== Import Dashboard for demo-v80 ===" -ForegroundColor Cyan
...
Write-Host "Dashboard import completed for demo-v80!" -ForegroundColor Green