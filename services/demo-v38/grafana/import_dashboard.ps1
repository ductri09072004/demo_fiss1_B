# Script import dashboard cho demo-v38
param(
...
Write-Host "=== Import Dashboard for demo-v38 ===" -ForegroundColor Cyan
...
Write-Host "Dashboard import completed for demo-v38!" -ForegroundColor Green