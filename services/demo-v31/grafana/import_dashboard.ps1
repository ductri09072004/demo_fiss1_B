# Script import dashboard cho demo-v31
param(
...
Write-Host "=== Import Dashboard for demo-v31 ===" -ForegroundColor Cyan
...
Write-Host "Dashboard import completed for demo-v31!" -ForegroundColor Green
