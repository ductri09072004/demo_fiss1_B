# Script import dashboard cho demo-v78
param(
...
Write-Host "=== Import Dashboard for demo-v78 ===" -ForegroundColor Cyan
...
Write-Host "Dashboard import completed for demo-v78!" -ForegroundColor Green