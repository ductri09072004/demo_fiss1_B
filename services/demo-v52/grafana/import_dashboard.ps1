# Script import dashboard cho demo-v52
param(
...
Write-Host "=== Import Dashboard for demo-v52 ===" -ForegroundColor Cyan
...
Write-Host "Dashboard import completed for demo-v52!" -ForegroundColor Green