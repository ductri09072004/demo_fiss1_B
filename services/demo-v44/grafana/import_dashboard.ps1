# Script import dashboard cho demo-v44
param(
...
Write-Host "=== Import Dashboard for demo-v44 ===" -ForegroundColor Cyan
...
Write-Host "Dashboard import completed for demo-v44!" -ForegroundColor Green