# Script import dashboard cho demo-v64
param(
...
Write-Host "=== Import Dashboard for demo-v64 ===" -ForegroundColor Cyan
...
Write-Host "Dashboard import completed for demo-v64!" -ForegroundColor Green